...
// 移动指针法
// const asyncPool = (requests, limit) => {
//   return new Promise((resolve) => {
...
//       requests[index]().then((res) => {
//         count += 1
//         next += 1
//         result[index] = res
//         console.log('task: ', res)
//         if (count === len) resolve(result)
//         if (next < len) executeTask(next)
//       })
//     }
...
//         index += 1
//         // if (count === len) return
//         if (index < len) handleTask(tasks[index])
//       })
//     }
//     for (let i = 0; i < limit; i++) {
//       handleTask(tasks[i])
